...
## Which Proof Type Should I Choose?

### Choose Standard Proof (Free) if you...

- Want to participate in the 2026 experiment without spending money
- Don't need instant verification
- Are okay with your proof being part of a daily batch
- Want to try the platform before committing financially
...
### Choose Perpetual Proof (Paid) if you...

- Want to **own** your creation as a digital asset
- Need **instant** on-chain verification (within seconds)
- Want your trail stored **permanently** on decentralized storage
- Plan to showcase it on NFT marketplaces like OpenSea
...
- Exclusive "Perpetual Proof" badge on your profile
- Full ownership—you can transfer, sell, or hold forever
...
The first 45 seconds are included in the base fee, so shorter trails are more affordable.

## Payment Options: Which Should I Use?

### Option 1: POL (Polygon Token)

**Best if you:** Already have crypto in your wallet

- Pay directly with Polygon's native token
- Requires signing a transaction in your wallet
...
### Option 2: TIME26 Token

**Best if you:** Want to use tokens you earned on the platform

- Our native token for the 2026 experiment
- Earn by inviting friends (referrals) and engaging with proofs
...
### Option 3: Gasless Minting (Unclaimed TIME26)

**Best if you:** Have unclaimed TIME26 rewards and want the easiest experience

- Use your pending TIME26 balance directly
- **No wallet signature needed**—completely gasless!
- The smoothest minting experience

**How it works:**
Your unclaimed TIME26 rewards can be spent without ever claiming them to your wallet. This means no gas fees and no transaction signing—just click and mint.
...
1. **Create your trail** on the [Canvas](/canvas)
   - Draw for at least 10 seconds
   - Take your time—this will be forever on the blockchain

2. **Click "Submit Proof"**
   - You'll see the proof type selection screen

3. **Select "Perpetual Proof"**
   - Review the cost shown for your trail duration

4. **Choose your payment method**
   - POL: Direct payment from wallet
   - TIME26: Use claimed tokens
   - Gasless: Use unclaimed balance (recommended if available)

5. **Personalize your proof (optional but recommended)**
   - **Artwork Title**: Give your creation a name
   - **Description**: Describe what inspired you
   - **On-chain Name**: The name shown publicly (or stay anonymous)
   - **Message to the World**: Leave words for future generations

6. **Confirm and mint**
   - For POL/TIME26: Sign the transaction in your wallet
   - For Gasless: Just click confirm—no signature needed!
...
Ready to create something eternal? [Start drawing →](/canvas)
