...
const PlaybackCanvas = dynamic(
  () =>
    import('@/components/canvas/playback-canvas').then(
      (mod) => mod.PlaybackCanvas
    ),
  {
    ssr: false,
    loading: () => <div className="w-full h-full bg-transparent" />,
...
export function ProofViewer({
  ...
  return (
    <div className="w-full h-screen relative bg-transparent overflow-hidden flex flex-col">
      ...
      {/* Controls Overlay (Bottom Right) - Hidden in playback mode */}
      {viewMode === 'static' && (
      ...
      {/* Footer / Tx Hash - Hidden in playback mode */}
      {viewMode === 'static' && (
