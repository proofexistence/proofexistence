...
--> statement-breakpoint
ALTER TABLE "sessions" ADD COLUMN "nsfw" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "sessions" ADD COLUMN "nsfw_marked_by" uuid;--> statement-breakpoint
ALTER TABLE "sessions" ADD COLUMN "nsfw_marked_at" timestamp with time zone;--> statement-breakpoint
...
CREATE INDEX "user_daily_quests_user_date_idx" ON "user_daily_quests" USING btree ("user_id","date");--> statement-breakpoint
ALTER TABLE "sessions" ADD CONSTRAINT "sessions_nsfw_marked_by_users_id_fk" FOREIGN KEY ("nsfw_marked_by") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;