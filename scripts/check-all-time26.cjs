...
async function main() {
  ...
  const addresses = [
    { name: 'ProofRecorder v4', addr: '0x72Ac729a8f6efb68A5d6765EC375aC4578a3c756' },
    { name: 'Uniswap Pool', addr: '0xE11f0a3Acb5165015858a5FF8ba09746F26Ac05b' },
    { name: 'Main Safe (Team/Ops)', addr: '0xc7b9ED3e985706efeb951462d4281f4Ac8fc99B2' },
    { name: 'LP Phase 2&3 Wallet', addr: '0xd4A3FBBFaE24985A667F9FAf2c11C4687D72100A' },
    { name: 'Treasury Safe (new)', addr: '0xBDA2B288154339F88F886949F4CC9dF7D2491f6D' },
    { name: 'Sablier Linear', addr: '0x3962f6585946823440d274aD7C719B02b49DE51E' },
    { name: 'Sablier Dynamic', addr: '0x7CC7e125d83A581ff438608490Cc0f7bDff79127' },
    { name: 'Team Recipient', addr: '0x19C7223EfA11A6eCaaac4c943225CC6EFE12A5Fd' },
  ...
  for (const { name, addr } of addresses) {
    try {
      ...
      if (formatted > 0) {
        ...
        console.log(`✓ ${name.padEnd(22)} ${formatted.toLocaleString().padStart(18)} TIME26  (${pct}%)`);
        console.log(`  ${addr}`);
        console.log('');
      }
    } catch (e) {
  ...
  console.log(`Total Found:   ${foundNum.toLocaleString().padStart(18)} TIME26`);
  console.log(`Missing:       ${missingNum.toLocaleString().padStart(18)} TIME26`);
  console.log('='.repeat(70));
