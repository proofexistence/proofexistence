...
async function main() {
  ...
  console.log(
    '   Total supply:',
    ethers.utils.formatEther(await time26.totalSupply()),
    'TIME26'
  );
  console.log('');
  ...
  console.log(
    '      - Base (POL):',
    ethers.utils.formatEther(PRICING.baseFeeNative),
    'POL'
  );
  console.log(
    '      - Per second (POL):',
    ethers.utils.formatEther(PRICING.pricePerSecondNative),
    'POL'
  );
  console.log(
    '      - Base (TIME26):',
    ethers.utils.formatUnits(PRICING.baseFeeTime26, 18),
    'TIME26'
  );
  console.log(
    '      - Per second (TIME26):',
    ethers.utils.formatUnits(PRICING.pricePerSecondTime26, 18),
    'TIME26'
  );
  ...
  console.log(
    `   - 31,536,000 TIME26 → ProofRecorder (${proofRecorderAddress})`
  );
  ...
  console.log('');
  console.log(
    `npx hardhat verify --network polygon ${time26Address} "${deployer.address}"`
  );
  console.log('');
  console.log(
    `npx hardhat verify --network polygon ${proofRecorderAddress} "${time26Address}" "${TREASURY_SAFE}" "${OPERATOR_WALLET}" "${TREASURY_SAFE}"`
  );
  console.log('');
